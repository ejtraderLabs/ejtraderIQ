...
from ejtraderIQ.http.login import Login
from ejtraderIQ.http.loginv2 import Loginv2
from ejtraderIQ.http.logout import Logout
from ejtraderIQ.http.getprofile import Getprofile
from ejtraderIQ.http.auth import Auth
from ejtraderIQ.http.token import Token
from ejtraderIQ.http.appinit import Appinit
from ejtraderIQ.http.billing import Billing
from ejtraderIQ.http.buyback import Buyback
from ejtraderIQ.http.changebalance import Changebalance
from ejtraderIQ.http.events import Events
from ejtraderIQ.ws.client import WebsocketClient
from ejtraderIQ.ws.chanels.get_balances import *

from ejtraderIQ.ws.chanels.ssid import Ssid
from ejtraderIQ.ws.chanels.subscribe import *
from ejtraderIQ.ws.chanels.unsubscribe import *
from ejtraderIQ.ws.chanels.setactives import SetActives
from ejtraderIQ.ws.chanels.candles import GetCandles
from ejtraderIQ.ws.chanels.buyv2 import Buyv2
from ejtraderIQ.ws.chanels.buyv3 import *
from ejtraderIQ.ws.chanels.user import *
from ejtraderIQ.ws.chanels.api_game_betinfo import Game_betinfo
from ejtraderIQ.ws.chanels.instruments import Get_instruments
from ejtraderIQ.ws.chanels.get_financial_information import GetFinancialInformation
from ejtraderIQ.ws.chanels.strike_list import Strike_list
from ejtraderIQ.ws.chanels.leaderboard import Leader_Board

from ejtraderIQ.ws.chanels.traders_mood import Traders_mood_subscribe
from ejtraderIQ.ws.chanels.traders_mood import Traders_mood_unsubscribe
from ejtraderIQ.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from ejtraderIQ.ws.chanels.get_order import Get_order
from ejtraderIQ.ws.chanels.get_deferred_orders import GetDeferredOrders
from ejtraderIQ.ws.chanels.get_positions import *
 
from ejtraderIQ.ws.chanels.get_available_leverages import Get_available_leverages
from ejtraderIQ.ws.chanels.cancel_order import Cancel_order
from ejtraderIQ.ws.chanels.close_position import Close_position
from ejtraderIQ.ws.chanels.get_overnight_fee import Get_overnight_fee
from ejtraderIQ.ws.chanels.heartbeat import Heartbeat

 
from ejtraderIQ.ws.chanels.digital_option import *
from ejtraderIQ.ws.chanels.api_game_getoptions import *
from ejtraderIQ.ws.chanels.sell_option import Sell_Option
from ejtraderIQ.ws.chanels.change_tpsl import Change_Tpsl
from ejtraderIQ.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from ejtraderIQ.ws.objects.timesync import TimeSync
from ejtraderIQ.ws.objects.profile import Profile
from ejtraderIQ.ws.objects.candles import Candles
from ejtraderIQ.ws.objects.listinfodata import ListInfoData
from ejtraderIQ.ws.objects.betinfo import Game_betinfo_data
import ejtraderIQ.global_value as global_value
...
class IQOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <ejtraderIQ.http.resource.Resource>`.
    ...
    def loginv2(self):
        ...
        :returns: The instance of :class:`Loginv2
            <ejtraderIQ.http.loginv2.Loginv2>`.
        """
        return Loginv2(self)
    ...
    def appinit(self):
        ...
        :returns: The instance of :class:`Appinit
            <ejtraderIQ.http.appinit.Appinit>`.
        """
        return Appinit(self)
    ...
    #         <ejtraderIQ.http.profile.Profile>`.
    #     """
    #     return Profile(self)
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <ejtraderIQ.http.changebalance.Changebalance>`.
        """
    ...
    def billing(self):
        ...
        :returns: The instance of :class:`Billing
            <ejtraderIQ.http.billing.Billing>`.
        """
        return Billing(self)
    ...
    def buyback(self):
        ...
        :returns: The instance of :class:`Buyback
            <ejtraderIQ.http.buyback.Buyback>`.
        """
        return Buyback(self)
# ------------------------------------------------------------------------
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <ejtraderIQ.http.getprofile.Getprofile>`.
        """
...
# ----------------------------------------------------------------------------
    ...
    def ssid(self):
        ...
        :returns: The instance of :class:`Ssid
            <ejtraderIQ.ws.chanels.ssid.Ssid>`.
        """
        return Ssid(self)
# --------------------------------------------------------------------------------
    @property
...
# --------------------------------------------------------------------------------
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <ejtraderIQ.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <ejtraderIQ.ws.chanels.unsubscribe.Unsubscribe>`.
        """
...
# -----------------------------------------------------------------------------------
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <ejtraderIQ.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <ejtraderIQ.ws.chanels.candles.GetCandles>`.
        """
...
# ____________for_______binary_______option_____________
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <ejtraderIQ.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
